...
import { executeTransformation } from "./transformations.api";
import { useTransformableProducts, useTransformationHistory } from "./transformations.hooks";
import { TransformationDirection } from "./transformations.types";
...
export default function TransformationsPage() {
  ...
  const { history, total, totalPages, loading: historyLoading, error: historyError, reload: reloadHistory } =
    useTransformationHistory(page);
